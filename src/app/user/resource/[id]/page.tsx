...
import { FileText, Play, Lock, ArrowLeft, ExternalLink } from "lucide-react";
                    ...
                    <div className="w-full h-full flex items-center justify-center">
                      <div className="text-center text-white">
                        ...
                        <p className="text-gray-300 mb-4">
                          Exclusive high-quality video tutorial
                        </p>
                  ...
                  <>
                    {resource.url && (
                      <button
                        ...
                        className="w-full bg-gray-900 text-white py-2.5 px-4 rounded-lg text-sm font-medium hover:bg-gray-800 transition-colors flex items-center justify-center gap-2"
                      >
