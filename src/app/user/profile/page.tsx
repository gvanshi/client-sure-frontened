                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                      <h4 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                        <span className="mr-2">✏️</span> Edit Personal
                        Information
                      </h4>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                    <div className="bg-blue-50 p-6 rounded-lg">
                      ...
                      <div className="text-3xl font-bold text-blue-600 mb-2">
                        {userProfile.tokens.daily}
                      </div>
                      <div className="text-sm text-blue-700">
                        of {userProfile.tokens.dailyLimit} available
                      </div>
                      <div className="bg-blue-200 rounded-full h-2 mt-3">
                        <div
                          className="bg-blue-600 h-2 rounded-full"
                          style={{
                            width: `${(userProfile.tokens.daily / userProfile.tokens.dailyLimit) * 100}%`,
                          }}
                        ></div>
                      </div>
                    </div>
                    ...
                    <div className="bg-green-50 p-6 rounded-lg">
                      ...
                      <div className="text-3xl font-bold text-green-600 mb-2">
                        {userProfile.tokens.monthlyRemaining}
                      </div>
                      <div className="text-sm text-green-700">
                        of {userProfile.tokens.monthlyTotal} remaining
                      </div>
                      <div className="bg-green-200 rounded-full h-2 mt-3">
                        <div
                          className="bg-green-600 h-2 rounded-full"
                          style={{
                            width: `${(userProfile.tokens.monthlyRemaining / userProfile.tokens.monthlyTotal) * 100}%`,
                          }}
                        ></div>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <div className="text-center">
                        <div className="text-2xl font-bold text-purple-600">
                          {userProfile.tokens.totalUsed}
                        </div>
                        <div className="text-sm text-gray-600">Total Used</div>
                      </div>
                      <div className="text-center">
                        <div className="text-2xl font-bold text-orange-600">
                          {userProfile.tokens.dailyUsed}
                        </div>
                        <div className="text-sm text-gray-600">Used Today</div>
                      </div>
                      <div className="text-center">
                        <div className="text-2xl font-bold text-red-600">
                          {userProfile.tokens.monthlyUsed}
                        </div>
                    ...
                    <div className="bg-purple-600 rounded-lg p-8 text-white mb-8 shadow-lg">
                      <div className="text-center">
                        ...
                        <div className="text-5xl font-bold">
                          ${userProfile.subscription.plan.price}
                      ...
                      <div className="space-y-4">
                        <div className="flex justify-between items-center py-2 border-b border-gray-100">
                          ...
                          <span className="font-semibold text-blue-600">
                            {userProfile.tokens.monthlyTotal}
                          </span>
                        </div>
                        <div className="flex justify-between items-center py-2 border-b border-gray-100">
                          <span className="text-gray-600 font-medium">
                      ...
                      <div>
                        ...
                        <div className="bg-gray-200 rounded-full h-2">
                          <div
                            className="bg-blue-600 h-2 rounded-full"
                            style={{
                              width: `${(userProfile.tokens.monthlyUsed / userProfile.tokens.monthlyTotal) * 100}%`,
                            }}
                          ></div>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="bg-gray-200 rounded-full h-2">
                          <div
                            className="bg-green-600 h-2 rounded-full"
                            style={{
                              width: `${(userProfile.tokens.dailyUsed / userProfile.tokens.dailyLimit) * 100}%`,
                            }}
                          ></div>
                        </div>
                      </div>
                  ...
                  <div className="flex justify-between items-center mb-6">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Stay updated with community activities and system
                        updates
                      </p>
                    </div>
              ...
              {activeSection === "Accessed Resources" && (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-6">
                    View all the resources you've accessed
                  </p>
                  <button
