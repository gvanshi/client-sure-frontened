            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 text-center shadow-sm">
                ...
                <div className="text-4xl font-bold text-purple-600 mb-2">
                  ...
                  <span className="text-lg text-purple-400">Tokens</span>
                </div>
                    ...
                    >
                      ...
                      <div className="text-right">
                        <div className="group relative inline-block">
                          <span
                            className={`px-3 py-1 rounded-full text-xs font-medium cursor-help ${
                              referral.isActive
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="text-right text-sm">
                    <div className="font-medium text-purple-600">
                      Total Cycles: {milestoneData.totalCycles}
                    </div>
                    <div className="text-gray-600">
                      Total Earned: {milestoneData.totalTokensEarned} tokens
                    </div>
                  </div>
                </div>
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <div className="font-medium text-gray-900">
                              {milestone.target} Referrals → {milestone.reward}{" "}
                              Tokens
                            </div>
                            <div className="text-sm text-gray-600">
                              Cycle #{milestone.nextCycleNumber} • Completed:{" "}
                              {milestone.cyclesCompleted} times
                            </div>
                            <div className="text-xs text-green-600">
                              Earned from this milestone:{" "}
                              {milestone.tokensEarnedFromThis} tokens
                            </div>
                          </div>
                        </div>
                        <div className="text-right">
                          {milestone.isEligible ? (
                            ...
                            <div>
                              ...
                              <span className="text-xs text-gray-400">
                                {milestone.target - milestone.current} more
                                needed
                              </span>
                            </div>
                          )}
                      ...
                      <div className="flex justify-between text-xs text-gray-500">
                        ...
                        {milestone.lastReset && (
                          <span>
                            Last reset:{" "}
                            {new Date(milestone.lastReset).toLocaleDateString()}
                          </span>
                        )}
                      </div>
                    </div>
                ...
                <div className="mt-4 p-3 bg-blue-50 rounded-lg">
                  <div className="text-sm text-blue-800">
                    <strong>How Cycles Work:</strong> When you reach a
                    milestone, you get tokens and your progress resets to 0. You
                    can achieve the same milestone multiple times to earn more
                    rewards!
                  </div>
                </div>
              </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                ...
                <div className="text-center">
                  ...
                  <div className="text-blue-700">
                    Your friends join using your code
                  </div>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 bg-blue-600 text-white rounded-full flex items-center justify-center mx-auto mb-2 font-bold">
