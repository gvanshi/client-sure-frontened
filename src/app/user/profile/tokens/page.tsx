              ...
              <div className="space-y-8">
                ...
                {tokenBalance?.hasExtraTokens && (
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-8">
                    ...
                    <p className="text-blue-700 text-sm mt-1">
                      You have {tokenBalance.extra} extra tokens that will
                      expire at midnight (1:00 AM).
                    </p>
                  </div>
                )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="bg-green-50 p-6 rounded-lg border border-green-200">
                    ...
                    <div className="text-3xl font-bold text-green-600 mb-2">
                      {tokens.monthlyRemaining}
                    </div>
                    <div className="text-sm text-green-700">
                      of {tokens.monthlyTotal} remaining
                    </div>
                    <div className="bg-green-200 rounded-full h-3 mt-3">
                      <div
                        className="bg-green-600 h-3 rounded-full transition-all duration-300"
                        style={{
                          width: `${(tokens.monthlyRemaining / tokens.monthlyTotal) * 100}%`,
                        }}
                      ></div>
                    </div>
                    <div className="text-xs text-green-600 mt-2">
                      {(
                        (tokens.monthlyRemaining / tokens.monthlyTotal) *
                        100
                      ).toFixed(1)}
                      % remaining
                    </div>
