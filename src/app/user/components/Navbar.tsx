    ...
    const loadTokens = async () => {
      try {
        ...
        setTokens({
          ...
          effectiveTokens:
            response.data.tokens.effectiveTokens || response.data.tokens.daily,
        });
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-1 flex-1">
            <Link
              href="/user/dashboard"
              className="flex items-center space-x-2 px-4 py-2 rounded-lg text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors"
            >
      ...
      {isMenuOpen && (
        <div className="md:hidden border-t border-gray-200 bg-white">
          <div className="px-4 py-3 space-y-1">
            <Link
              href="/user/dashboard"
              className="flex items-center space-x-3 px-3 py-2.5 rounded-lg text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors"
            >
