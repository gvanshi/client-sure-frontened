                    ...
                    <div className="flex justify-between items-start mb-4 gap-2">
                      <div className="flex items-center gap-3 min-w-0 flex-1">
                        ...
                        <div className="min-w-0 flex-1">
                          <h3 className="font-semibold text-gray-900 truncate">{post.user_id.name}</h3>
                          <p className="text-sm text-gray-500 truncate">{post.user_id.email}</p>
                      ...
                      >
                        ...
                        <span className="hidden sm:inline">Delete Post (-5 pts)</span>
                            ...
                            <div key={comment._id} className="bg-white p-3 rounded-lg">
                              <div className="flex justify-between items-start gap-2">
                                ...
                                >
                                  ...
                                  <span className="hidden sm:inline">Delete (-2 pts)</span>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {leaderboard.slice(0, 12).map((user, index) => (
                    <div key={user._id} className={`flex items-center gap-3 p-4 rounded-lg transition-colors ${
                      index < 3 ? 'bg-yellow-50 border border-yellow-200' : 'bg-[#BDDDFC]/20 hover:bg-[#BDDDFC]'
                    }`}>
